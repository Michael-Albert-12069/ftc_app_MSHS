 ...
 */
@Autonomous(name = "Michael - Auto. 3a", group = "Autonomous")
public class AutonomousPosition3a extends LinearOpMode {
    ...
    public void CloseServo(){armclaw.setPosition(ARMCLOSE);}

    public void LiftSlide(int time, String fam) throws InterruptedException {
        armmotor.setPower(1);
        Thread.sleep(time * 1000);
    }
    public void OpenServo(){armclaw.setPosition(ARMOPEN);}
